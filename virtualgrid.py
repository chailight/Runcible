...
class VirtualGridWrapper(monome.GridWrapper):
    ...
    def led_row(self, x_offset, y, data):
        if data.shape[0] == 16:
            self.grid1_row_data, self.grid2_row_data = np.vsplit(data,2)
...
class PhysicalGridWrapper_1(monome.GridWrapper):
    ...
    def led_map(self, x_offset, y_offset, data):
        ...
        #self.grid.led_map(x_offset, y_offset, np.flipud(data).astype(int).tolist())
        #self.grid.led_map(x_offset, y_offset, np.fliplr(np.rot90(data)).astype(int).tolist())
        self.grid.led_map(x_offset, y_offset, np.flipud(np.fliplr(np.rot90(data))).astype(int).tolist())
...
class PhysicalGridWrapper_2(monome.GridWrapper):
    ...
    def led_map(self, x_offset, y_offset, data):
        ...
        #self.grid.led_map(x_offset, y_offset, np.rot90(np.rot90(np.fliplr(data))).astype(int).tolist())
