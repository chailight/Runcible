...
class Runcible(monome.App):
    ...
    def draw_scale_page(self):
        ...
        for sd in range (1,8):
            ...
            self.my_buffer.led_row(0,self.my_buffer.levels.T[sd]+sd,np.roll((self.my_pos_buffer).astype(int),7+self.cur_trans+self.current_preset.scale_data[self.cur_scale_id][sd],axis=1))
